...
func TestPropertyValue(t *testing.T) {
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("title", e.Text, WithType(Qual("RichTextArray")))
	})
	c.ExpectBlock(&Block{
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("rich_text", e.Text, WithType(Qual("RichTextArray")))
	})
	c.ExpectBlock(&Block{
		Kind: "FencedCodeBlock",
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("select", e.Text, WithType(jen.Op("*").Add(Qual("Option")))) // may null
	})
	c.ExpectParameter(&Parameter{
		Property:     "id",
		Type:         "string (UUIDv4)",
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("status", e.Text, WithType(jen.Op("*").Add(Qual("Option"))))
	})
	c.ExpectParameter(&Parameter{
		Property:     "id",
		Type:         "string (UUIDv4)",
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("multi_select", e.Text, WithType(jen.Index().Add(Qual("Option"))))
	})
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("formula", e.Text, WithType(jen.Op("*").Add(Qual("Formula"))))
	})
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("relation", e.Text, WithType(jen.Index().Add(Qual("PageReference"))))
	})
	c.ExpectBlock(&Block{
		Kind: "Paragraph",
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("rollup", e.Text, WithType(jen.Op("*").Add(Qual("Rollup"))))
	})
	c.ExpectBlock(&Block{
		Kind: "FencedCodeBlock",
		Text: "{\n  \"Rollup\": {\n    \"id\": \"aJ3l\",\n    \"rollup\": {\n      \"type\": \"number\",\n      \"number\": 1234,\n      \"function\": \"sum\"\n    }\n  }\n}",
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("people", e.Text, WithType(jen.Index().Add(Qual("User"))))
	})
	c.ExpectBlock(&Block{
		Kind: "FencedCodeBlock",
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("files", e.Text, WithType(jen.Index().Add(Qual("File"))))
	})
	c.ExpectBlock(&Block{
		Kind: "FencedCodeBlock",
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("created_time", e.Text, WithType(Qual("ISO8601String")))
	})
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("created_by", e.Text, WithType(Qual("User")))
	})
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("last_edited_time", e.Text, WithType(Qual("ISO8601String")))
	})
	...
	c.ExpectBlock(&Block{
		...
		propertyValue.AddPayloadField("last_edited_by", e.Text, WithType(Qual("User")))
	})
