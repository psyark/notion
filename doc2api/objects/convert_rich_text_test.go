...
func TestRichText(t *testing.T) {
	...
	converter.FetchDocument("https://developers.notion.com/reference/rich-text").WithScope(func(c *DocumentComparator) {
		...
		c.WithScope(func(c *DocumentComparator) {
			var annotations *ConcreteObject
		...
		c.WithScope(func(c *DocumentComparator) {
			var richTextEquation *ConcreteObject
		...
		c.WithScope(func(c *DocumentComparator) {
			...
			var mentionLinkPreview *ConcreteObject
		...
		c.WithScope(func(c *DocumentComparator) {
			var richTextText *ConcreteObject
