	...
	registerConverter(converter{
		...
		localCopy: []objectDocElement{
			...
			&objectDocCalloutElement{
				...
				Type:  "info",
				output: func(e *objectDocCalloutElement, b *builder) {
					getSymbol[concreteObject](b, "TitlePropertyValue").comment += "\n\n" + e.Body
				},
			},
			&objectDocHeadingElement{
			...
			&objectDocCalloutElement{
				...
				Type:  "info",
				output: func(e *objectDocCalloutElement, b *builder) {
					getSymbol[concreteObject](b, "RichTextPropertyValue").comment += "\n\n" + e.Body
				},
			},
			&objectDocHeadingElement{
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "NumberPropertyValue").addFields(&field{
						name:     "number",
						typeCode: NullFloat,
						comment:  e.Text,
					})
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "SelectPropertyValue").addFields(&field{
						name:     "select",
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "StatusPropertyValue").addFields(&field{
						name:     "status",
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "MultiSelectPropertyValue").addFields(&field{
						name:     "multi_select",
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "DatePropertyValue").addFields(&field{
						name:     "date",
						typeCode: jen.Op("*").Id("DatePropertyValueData"), // null
						comment:  e.Text,
					})
					// 本来typeObjectを使いたいが、PropertyValueDataのバインディング利用の特殊性からこうしている
					b.addConcreteObject("DatePropertyValueData", e.Text)
				},
			},
			&objectDocParametersElement{{
				Property:     "start",
				...
				output: func(e *objectDocParameter, b *builder) {
					getSymbol[concreteObject](b, "DatePropertyValueData").addFields(e.asField(jen.Id("ISO8601String")))
				},
			}, {
				Property:     "end",
				...
				ExampleValue: `"2020-12-08T12:00:00Z"`,
				output: func(e *objectDocParameter, b *builder) {
					getSymbol[concreteObject](b, "DatePropertyValueData").addFields(e.asField(jen.Op("*").Id("ISO8601String")))
				},
			}, {
				Property:     "time_zone",
				...
				output: func(e *objectDocParameter, b *builder) {
					getSymbol[concreteObject](b, "DatePropertyValueData").addFields(e.asField(jen.Op("*").String()))
				},
			}},
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "FormulaPropertyValue").comment += e.Text
				},
			},
			&objectDocCalloutElement{
				...
				Type:  "warning",
				output: func(e *objectDocCalloutElement, b *builder) {
					getSymbol[concreteObject](b, "FormulaPropertyValue").comment += "\n" + e.Title + "\n" + e.Body
				},
			},
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "{\n  \"Formula\": {\n    \"id\": \"1lab\",\n    \"formula\": {\n      \"type\": \"number\",\n      \"number\": 1234\n    }\n  }\n}",
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "StringFormula").addFields(&field{
						name:     "string",
						typeCode: NullString,
						comment:  e.Text,
					})
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "NumberFormula").addFields(&field{
						name:     "number",
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "BooleanFormula").addFields(&field{
						name:     "boolean",
						typeCode: jen.Bool(),
						comment:  e.Text,
					})
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "DateFormula").addFields(&field{
						name:     "date",
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "RelationPropertyValue").comment += e.Text
					getSymbol[concreteObject](b, "RelationPropertyValue").addFields(&field{
						name:     "relation",
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "RollupPropertyValue").comment += e.Text
				},
			},
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "{\n  \"Rollup\": {\n    \"id\": \"aJ3l\",\n    \"rollup\": {\n      \"type\": \"number\",\n      \"number\": 1234,\n      \"function\": \"sum\"\n    }\n  }\n}",
			...
			&objectDocCalloutElement{
				...
				Type:  "warning",
				output: func(e *objectDocCalloutElement, b *builder) {
					getSymbol[concreteObject](b, "RollupPropertyValue").comment += "\n\n" + e.Title + "\n" + e.Body
				},
			},
			&objectDocHeadingElement{
			...
			&objectDocCalloutElement{
				...
				Type:  "info",
				output: func(e *objectDocCalloutElement, b *builder) {
					getSymbol[concreteObject](b, "PeoplePropertyValue").comment += "\n\n" + e.Body
				},
			},
			&objectDocHeadingElement{
			...
			&objectDocCalloutElement{
				...
				Type:  "info",
				output: func(e *objectDocCalloutElement, b *builder) {
					getSymbol[concreteObject](b, "FilesPropertyValue").comment += "\n\n" + e.Title + "\n" + e.Body
				},
			},
			&objectDocHeadingElement{
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "CheckboxPropertyValue").addFields(&field{
						name:     "checkbox",
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "UrlPropertyValue").addFields(&field{
						name:     "url",
						typeCode: NullString,
						comment:  e.Text,
					})
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "EmailPropertyValue").addFields(&field{
						name:     "email",
						typeCode: NullString,
						comment:  e.Text,
					})
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "PhoneNumberPropertyValue").addFields(&field{
						name:     "phone_number",
						typeCode: NullString,
						comment:  e.Text,
					})
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "CreatedTimePropertyValue").addFields(&field{
						name:     "created_time",
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					getSymbol[concreteObject](b, "LastEditedTimePropertyValue").addFields(&field{
