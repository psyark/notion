...
// convert は変換を実行します
func (c converter) convert(global *builder) error {
	// URLの取得
...
func convertAll() error {
	...
	for _, c := range registeredConverters {
		c := c
		eg.Go(func() error {
			if err := c.convert(global); err != nil {
	...
	file := jen.NewFile("notion")
	file.Comment("Code generated by notion.doc2api; DO NOT EDIT.")
	file.Add(global.statement()...)

	return file.Save("../../object.global.go")
}
