	...
	registerConverter(converter{
		...
		localCopy: []objectDocElement{
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "\"Task complete\": {\n  \"id\": \"BBla\",\n  \"name\": \"Task complete\",\n  \"type\": \"checkbox\",\n  \"checkbox\": {}\n}",
				Language: "json",
				Name:     "Example checkbox database property object",
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "\"Created by\": {\n  \"id\": \"%5BJCR\",\n  \"name\": \"Created by\",\n  \"type\": \"created_by\",\n  \"created_by\": {}\n}",
				Language: "json",
				Name:     "Example created by database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "\"Created time\": {\n  \"id\": \"XcAf\",\n  \"name\": \"Created time\",\n  \"type\": \"created_time\",\n  \"created_time\": {}\n}",
				Language: "json",
				Name:     "Example created time database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "\"Task due date\" {\n  \"id\": \"AJP%7D\",\n  \"name\": \"Task due date\",\n  \"type\": \"date\",\n  \"date\": {}\n}",
				Language: "json",
				Name:     "Example date database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "\"Contact email\": {\n  \"id\": \"oZbC\",\n  \"name\": \"Contact email\",\n  \"type\": \"email\",\n  \"email\": {}\n}",
				Language: "json",
				Name:     "Example email database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "\"Product image\": {\n  \"id\": \"pb%3E%5B\",\n  \"name\": \"Product image\",\n  \"type\": \"files\",\n  \"files\": {}\n}",
				Language: "json",
				Name:     "Example files database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				...
				Language: "json",
				Name:     "Example formula database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				...
				Language: "json",
				Name:     "Example last edited time database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				...
				Language: "json",
				Name:     "Example multi-select database property",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "\"Price\"{\n  \"id\": \"%7B%5D_P\",\n  \"name\": \"Price\",\n  \"type\": \"number\",\n  \"number\": {\n    \"format\": \"dollar\"\n  }\n}",
				Language: "json",
				Name:     "Example number database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "\"Project owner\": {\n  \"id\": \"FlgQ\",\n  \"name\": \"Project owner\",\n  \"type\": \"people\",\n  \"people\": {}\n}",
				Language: "json",
				Name:     "Example people database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				...
				Language: "json",
				Name:     "Example phone number database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				...
				Language: "json",
				Name:     "Example relation database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				...
				Language: "json",
				Name:     "Example rich text database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				...
				Language: "json",
				Name:     "Example rollup database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				...
				Language: "json",
				Name:     "Example select database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				...
				Language: "json",
				Name:     "Example status database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "\"Project name\": {\n  \"id\": \"title\",\n  \"name\": \"Project name\",\n  \"type\": \"title\",\n  \"title\": {}\n}",
				Language: "json",
				Name:     "Example title database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
			...
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
				Code:     "\"Project URL\": {\n  \"id\": \"BZKU\",\n  \"name\": \"Project URL\",\n  \"type\": \"url\",\n  \"url\": {}\n}",
				Language: "json",
				Name:     "Example URL database property object",
				output: func(e *objectDocCodeElementCode, b *builder) {
					b.addUnmarshalTest("PropertyMap", fmt.Sprintf(`{%s}`, e.Code))
				},
			}}},
