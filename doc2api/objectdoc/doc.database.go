		...
		localCopy: []objectDocElement{
			...
			&objectDocParametersElement{{
				...
				output: func(e *objectDocParameter, b *builder) {
					...
					b.getSpecificObject("Database").addFields(e.asFixedStringField())
				},
			}, {
				Field:        "id*",
				Type:         "string (UUID)",
				...
				output: func(e *objectDocParameter, b *builder) {
					e.Field = strings.TrimSuffix(e.Field, "*")
					b.getSpecificObject("Database").addFields(e.asField(UUID))
				},
			}, {
				Field:        "created_time",
				...
				output: func(e *objectDocParameter, b *builder) {
					b.getSpecificObject("Database").addFields(e.asField(jen.Id("ISO8601String")))
				},
			}, {
				Field:        "created_by",
				Type:         "Partial User",
				...
				output: func(e *objectDocParameter, b *builder) {
					b.getSpecificObject("Database").addFields(e.asField(jen.Id("PartialUser")))
				},
			}, {
				...
				output: func(e *objectDocParameter, b *builder) {
					b.getSpecificObject("Database").addFields(e.asField(jen.Id("RichTextArray")))
				},
			}, {
				Field:       "description",
				Type:        "array of rich text objects",
				...
				output: func(e *objectDocParameter, b *builder) {
					b.getSpecificObject("Database").addFields(e.asField(jen.Op("*").Id("ExternalFile")))
				},
			}, {
				...
				output: func(e *objectDocParameter, b *builder) {
					e.Field = strings.TrimSuffix(e.Field, "*")
					b.getSpecificObject("Database").addFields(e.asField(jen.Id("PropertyMap")))
				},
			}, {
				...
				Type:         "object",
				output: func(e *objectDocParameter, b *builder) {
					b.getSpecificObject("Database").addFields(e.asInterfaceField("Parent"))
				},
			}, {
				Field:        "url",
				Type:         "string",
				...
				output: func(e *objectDocParameter, b *builder) {
					b.getSpecificObject("Database").addFields(e.asField(jen.String()))
				},
			}, {
				Field:        "archived",
				Type:         "boolean",
				...
				ExampleValue: "false",
				output: func(e *objectDocParameter, b *builder) {
					b.getSpecificObject("Database").addFields(e.asField(jen.Bool()))
				},
			}, {
				Field:        "is_inline",
				Type:         "boolean",
