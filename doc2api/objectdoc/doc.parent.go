	...
	registerConverter(converter{
		...
		localCopy: []objectDocElement{
			...
			&objectDocParametersElement{{
				...
				output: func(e *objectDocParameter, b *builder) error {
					b.getSpecificObject("DatabaseParent").addFields(e.asField(jen.Qual("github.com/google/uuid", "UUID"), false))
					return nil
				},
			}},
			...
			&objectDocParametersElement{{
				...
				output: func(e *objectDocParameter, b *builder) error {
					b.getSpecificObject("PageParent").addFields(e.asField(jen.Qual("github.com/google/uuid", "UUID"), false))
					return nil
				},
			}},
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
			...
			&objectDocParametersElement{{
				...
				ExampleValues: "true",
				output: func(e *objectDocParameter, b *builder) error {
					b.getSpecificObject("WorkspaceParent").addFields(e.asField(jen.Bool(), false))
					return nil
				},
			}},
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
			...
			&objectDocParametersElement{{
				...
				output: func(e *objectDocParameter, b *builder) error {
					b.getSpecificObject("BlockParent").addFields(e.asField(jen.Qual("github.com/google/uuid", "UUID"), false))
					return nil
				},
			}},
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
