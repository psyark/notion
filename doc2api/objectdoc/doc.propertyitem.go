		...
		localCopy: []objectDocElement{
			...
			&objectDocParagraphElement{
				...
				output: func(e *objectDocParagraphElement, b *builder) {
					...
					getSymbol[concreteObject](b, "DatePropertyItem").typeObject.comment = e.Text
				},
			},
			&objectDocParametersElement{{
				Property:     "start",
				...
				output: func(e *objectDocParameter, b *builder) {
					getSymbol[concreteObject](b, "DatePropertyItem").typeObject.addFields(e.asField(jen.Id("ISO8601String")))
				},
			}, {
				Property:     "end",
				...
				ExampleValue: `"2020-12-08T12:00:00Z"`,
				output: func(e *objectDocParameter, b *builder) {
					getSymbol[concreteObject](b, "DatePropertyItem").typeObject.addFields(e.asField(jen.Op("*").Id("ISO8601String")))
				},
			}, {
				Property:     "time_zone",
				...
				output: func(e *objectDocParameter, b *builder) {
					getSymbol[concreteObject](b, "DatePropertyItem").typeObject.addFields(e.asField(NullString))
				},
			}},
			&objectDocCodeElement{Codes: []*objectDocCodeElementCode{{
